...
const vector<string> visualizationNames({"input for density", "input for velocity", "optical flow", "bridge velocity", "bridge density",  "bridge pressure", "obstacle", "fluid buoyancy", "fluid vorticity", "fluid temperature", "fluid divergence", "fluid pressure", "fluid velocity", "fluid density"});
